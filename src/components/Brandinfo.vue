...
export default {
   ...
   methods: {
      ...
      updatenew(){
         let _this=this;
         Object.keys(_this.form).forEach(key=>{_this.form[key]=_this.brandinfo[key]})
    ...
    onSubmit:function(formName){
       this.$refs[formName].validate((valid) => {
          if (valid) {
             let param={'name':this.form.name,'logo':this.form.logo,'brandStory':this.form.brandStory,'pics':this.form.pics,'productCount':this.form.productCount,'sort':this.form.sort,'showStatus':this.form.showStatus}
       this.$axios({
          method:'post',
...
this.$message({
    ...
    onUpdate:function(formName){
       ...
       let param={'id':this.$route.query.brandid,'name':this.form.name,'logo':this.form.logo,'brandStory':this.form.brandStory,'pics':this.form.pics,'productCount':this.form.productCount,'sort':this.form.sort,'showStatus':!this.form.showStatus-0}
       this.$axios({
          method:'post',
