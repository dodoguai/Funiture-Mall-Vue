  ...
  <div>
    ...
    >
      ...
      <el-table-column label="级别" width="180">
        <template slot-scope="scope">
          <span style="margin-left: 10px" v-if="scope.row.level == 0"
            >一级分类</span
          >
          <span style="margin-left: 10px" v-if="scope.row.level == 1"
            >二级分类</span
          >
        </template>
      </el-table-column>
      ...
      <el-table-column label="设置">
        <template slot-scope="scope">
          <el-button
            ...
            @click="viewafter(scope.row.id)"
            >查看下级</el-button
          >
          <el-button size="mini" v-if="scope.row.level == 1" disabled
            >查看下级</el-button
          >
        </template>
      </el-table-column>
